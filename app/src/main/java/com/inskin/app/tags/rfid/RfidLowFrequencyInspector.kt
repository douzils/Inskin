...
object RfidLowFrequencyInspector : TagInspector {
    ...
    override fun decode(channel: Channel, raw: ByteArray?): TagDetails {
        ...
        return TagDetails(uidHex = uid, techList = listOf("LF"), chipType = "LF 125kHz")
    }

    override fun write(channel: Channel, ops: List<WriteOp>): WriteReport =
        InspectorUtils.fail("Écriture LF à brancher via Proxmark")
}
